...
<body>
  ...
  <header id="header">
    <div class="container">
      ...
      <h1><a href="index.html">Angga Saeful</a></h1>
      <!-- Uncomment below if you prefer to use an image logo -->
      <!-- <a href="index.html" class="mr-auto"><img src="assets/img/logo.png" alt="" class="img-fluid"></a> -->
      <h2>I'm a passionate <span>Developer</span> from Bandung</h2>
    ...
    <div class="about-me container">
      ...
      <div class="row">
        <div class="col-lg-4" data-aos="fade-right">
          <img src="assets/img/angga.jpg" class="img-fluid" alt="">
        </div>
        <div class="col-lg-8 pt-4 pt-lg-0 content" data-aos="fade-left">
          <h3>UI/UX &amp; Backend Developer</h3>
          <p class="fst-italic">
          ...
          <div class="row">
            <div class="col-lg-6">
              <ul>
                <li><i class="bi bi-chevron-right"></i> <strong>Birthday:</strong> <span>7 April 2002</span></li>
                <li><i class="bi bi-chevron-right"></i> <strong>Website:</strong> <span>www.website.com</span></li>
                <li><i class="bi bi-chevron-right"></i> <strong>Phone:</strong> <span>082118161569</span></li>
            ...
            <div class="col-lg-6">
              <ul>
                ...
                <li><i class="bi bi-chevron-right"></i> <strong>PhEmailone:</strong> <span>angga@gmail.com</span></li>
      ...
      <div class="row">
        <div class="col-lg-6">
          ...
          <div class="resume-item pb-0">
            <h4>STT Bandung</h4>
            <p><em>Lorem ipsum dolor sit amet consectetur adipisicing elit. Rerum quidem repellat porro ea, voluptatibus itaque illo ipsam odio optio incidunt enim pariatur corrupti aut obcaecati cupiditate praesentium laboriosam nisi! Fugit.</em></p>
            <p>
            <ul>
              <li>Jl. Soekarno Hatta</li>
              <li>(123) 456-7891</li>
              <li>sttbandung@sttbandung.com</li>
            </ul>
            </p>
          </div>
          ...
          <div class="resume-item">
            ...
            <h5>2020 - NOW</h5>
            <p><em>STT Bandung, Bandung, IND</em></p>
            <p>Qui deserunt veniam. Et sed aliquam labore tempore sed quisquam iusto autem sit. Ea vero voluptatum qui ut dignissimos deleniti nerada porti sand markend</p>
          </div>
          <div class="resume-item">
            <h4>Software Engineering</h4>
            <h5>2017 - 2020</h5>
            <p><em>Katapang vocational Highschool, Bandung, IND</em></p>
        ...
        <div class="col-lg-6">
          ...
          <div class="resume-item">
            ...
            <h5>2018-2019</h5>
            <p><em>Diskominfo Jabar, Bandung, IND</em></p>
            <p>
            <ul>
      ...
      <!-- <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="assets/img/portfolio/portfolio-1.jpg" class="d-block w-80" alt="..." >
          ...
          <div class="carousel-item">
            <img src="assets/img/portfolio/portfolio-1.jpg" class="d-block" alt="...">
            <div class="carousel-caption d-none d-md-block">
          ...
          <div class="portfolio-wrap">
            ...
            <div class="portfolio-info">
              ...
              <div class="portfolio-links">
                ...
                <a href="/detail" data-gallery="portfolioDetailsGallery" data-glightbox="type: external" class="portfolio-details-lightbox" title="Portfolio Details"><i class="bx bx-link"></i></a>
              </div>
            </div>
          </div>
        </div>
  ...
  <div class="credits">
    Designed by <a href="https://bootstrapmade.com/">Angga</a>
  </div>
